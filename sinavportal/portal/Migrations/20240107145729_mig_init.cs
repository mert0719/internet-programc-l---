        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoruPuani = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userId = table.Column<int>(type: "int", nullable: false),
                    Cevap = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CevapPuani = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ogrenciSoruCevaps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ogrenciSoruCevaps_sorulars_SoruId",
                        column: x => x.SoruId,
                        principalTable: "sorulars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ogrenciSoruCevaps_users_userId",
                        column: x => x.userId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ogrenciSoruCevaps_SoruId",
                table: "ogrenciSoruCevaps",
                column: "SoruId");

            migrationBuilder.CreateIndex(
                name: "IX_ogrenciSoruCevaps_userId",
                table: "ogrenciSoruCevaps",
                column: "userId");
